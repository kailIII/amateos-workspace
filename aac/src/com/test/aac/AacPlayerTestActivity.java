...
public class AacPlayerTestActivity extends Activity {
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        aacMp3Player.playAsync( "http://205.188.215.229:8028" );   
 ...
 */
public class AacPlayerTestActivity extends Activity implements View.OnClickListener, PlayerCallback {
    ...
    public void playerException( final Throwable t) {
        uiHandler.post( new Runnable() {
            public void run() {
                new AlertDialog.Builder( AacPlayerTestActivity.this )
