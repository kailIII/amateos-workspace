 ...
 */
public class FriskyIntentReceiver extends BroadcastReceiver {
    @Override
        ...
        if (intent.getAction().equals(android.media.AudioManager.ACTION_AUDIO_BECOMING_NOISY)) {
            ...
            /*switch (keyEvent.getKeyCode()) {
                ...
                case KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE:
                    context.startService(new Intent(FriskyService.ACTION_TOGGLE_PLAYBACK));
                    break;
                case KeyEvent.KEYCODE_MEDIA_PLAY:
                    context.startService(new Intent(FriskyService.ACTION_PLAY));
                    break;
                case KeyEvent.KEYCODE_MEDIA_PAUSE:
                    context.startService(new Intent(FriskyService.ACTION_PAUSE));
                    break;
            }*/
        }
    }
