...
import org.inftel.socialwind.server.SocialWindRequestFactoryServlet;
...
public class RequestFactoryHelper {
    ...
    /**
     * Crea un {@link RequestFactory} que se comunica de forma directa, por tanto no usa red y los
     * eventos fire son sincronos.
     */
    ...
    private static void addExceptionHandler(SimpleRequestProcessor requestProcessor) {
        ExceptionHandler eh = new SocialWindRequestFactoryServlet.SocialWindExceptionHandler();
