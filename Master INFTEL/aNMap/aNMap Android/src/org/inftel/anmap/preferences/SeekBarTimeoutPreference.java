package org.inftel.anmap.preferences;
...
/**
 * Esta clase define un tipo de objeto SeekBar "customizado para la pantalla de preferencias
 *
 */
public class SeekBarTimeoutPreference extends Preference implements
	...
	public SeekBarTimeoutPreference(Context context) {
		super(context);
	}

	public SeekBarTimeoutPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SeekBarTimeoutPreference(Context context, AttributeSet attrs, int defStyle) {
