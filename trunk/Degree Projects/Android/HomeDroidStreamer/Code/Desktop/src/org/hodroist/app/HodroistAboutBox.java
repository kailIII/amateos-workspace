...
public class HodroistAboutBox extends javax.swing.JDialog {

    public HodroistAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.hodroist.app.HodroistApp.class).getContext().getResourceMap(HodroistAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(org.hodroist.app.HodroistApp.class).getContext().getActionMap(HodroistAboutBox.class, this);
