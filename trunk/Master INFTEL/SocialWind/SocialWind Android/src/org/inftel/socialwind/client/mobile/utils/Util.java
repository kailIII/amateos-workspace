...
import org.inftel.socialwind.client.mobile.comm.AndroidRequestTransport;
...
/**
 * Utility methods for getting the base URL for client-server communication and retrieving shared
 * preferences.
 */
public class Util {
     ...
     * {@code assets/debugging_prefs.properties} with a line of the form 'url=http:/<ip
     * address>:<port>'. A numeric IP address may be required in situations where the device or
     * emulator will not be able to resolve the hostname for the dev mode server.
     */
