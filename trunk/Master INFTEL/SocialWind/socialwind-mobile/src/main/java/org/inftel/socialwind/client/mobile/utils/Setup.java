...
/**
 * Class to be customized with app-specific data. The Eclipse plugin will set these values when the
 * project is created.
 */
public class Setup {
     ...
     */
    private static final String APP_NAME = "socialwindgwt";
    ...
    /**
     * The C2DM sender ID for the server. A C2DM registration with this name must exist for the app
