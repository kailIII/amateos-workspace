 ...
 *
 */
public class SeekBarThreadsPreference extends Preference implements
	...
	public SeekBarThreadsPreference(Context context) {
		super(context);
	}

	public SeekBarThreadsPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SeekBarThreadsPreference(Context context, AttributeSet attrs, int defStyle) {
