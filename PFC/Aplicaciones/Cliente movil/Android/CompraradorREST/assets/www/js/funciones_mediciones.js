var URLSERVER = "http://192.168.0.105/comprarador/android/";
...
$(document).ready(function() {
	...
	// /////////////////////////////////////////////
	// EVENTOS MEDICIÓN DE TIEMPOS DE RESPUESTA
	...
	$('#paginaProducto').live('pageshow', function(event, ui) {
		...
		if (typeof (window['tiempoInicioCodigoBarras']) != "undefined") {
			...
			console.log("  - Tiempo (ms) b�squeda c�digo barras: " + (tiempoFinCodigoBarras - tiempoInicioCodigoBarras));
		}
					...
					success : function(xml) {
						...
						$(xml).find('productos').each(function() {
							if ($(this).find('categoria').text() != "0") {
								...
								// se obtiene el precio del producto y se muestra
								eventoProductoListaCategoriaPulsado(id, marca, descripcion, formato);
								vistaProducto = true;
